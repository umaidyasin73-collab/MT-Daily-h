...
import { Plus, Trash2, MapPin, Search, Database, Download, Upload } from 'lucide-react';
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6" id="manage-cities-root">
      ...
      <div className="flex flex-col gap-6 lg:col-span-1">
        ...
        <motion.div
          ...
          className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 rounded-2xl p-5 shadow-sm flex flex-col gap-4 self-start w-full"
        >
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-2.5 mt-1">
            ...
            <motion.button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2.5 bg-[#010066] hover:bg-[#010066]/90 text-[#FFCB05] rounded-xl text-xs font-extrabold transition-all cursor-pointer shadow-sm border border-[#FFCB05]/20"
            >
              <Download className="w-4 h-4 text-[#FFCB05]" />
              <span>{t.exportBtn}</span>
            </motion.button>

            {/* Import Button Trigger */}
            <label className="flex items-center justify-center gap-2 px-4 py-2.5 bg-slate-50 hover:bg-slate-100 dark:bg-slate-950/40 dark:hover:bg-slate-950/75 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 rounded-xl text-xs font-bold transition-all cursor-pointer shadow-sm">
